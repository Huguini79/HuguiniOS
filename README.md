...
The operating system(including IDT interrumptions, disk driver, paging, gdt, vga driver, file parser, I/O ports, strng, memory heap), it's wrote in C and Assembly, and this version is constantly being updated. It's on Versión en C folder.
