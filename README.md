...
The operating system(including IDT interrumptions, disk driver, FAT16, gdt descriptor, kheap, string, pparser, paging, memory heap etc...), it's wrote in C and Assembly, and this version is constantly being updated.
